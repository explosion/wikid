...
class WikiKB(KnowledgeBase):
    ...
    def __init__(
        ...
        top_k_entities_fts (int): Top k of full-text search matches to consider. Equals maximum number of candidate
            entities found via full-text search.
        ...
        if self._paths["mentions_candidates"] is not None:
            with open(self._paths["mentions_candidates"], "rb") as file:
                self._mentions_candidates = {
                    mention_text: [Candidate(**cand) for cand in candidates]
    ...
    def get_candidates(self, mention: Span) -> Iterable[WikiKBCandidate]:
        ...
        RETURNS (Iterable[WikiKBCandidate]): Identified candidates.
        """
